...
<br>
<form action ="bookmark-group-add-data.jsp">
<table>
    <tr>
        <th>북마크 이름</th>
    ...
    <tr>
        <th>순서</th>
        <td><input type="number" id="orderNo" name="orderNo"></td>
    </tr>
    <tr>
        <td style="text-align: center;" colspan="2"><input type="submit" value="추가"></td>
    </tr>
</table>
</form>
</body>
